public class Constants {
  final static int[] widthValues = { 10, 20, 40, 80 };
  final static int[] heightValues = { 10, 20, 40 };
  ...
  public static String getNeighborhood(int index) {
    return neighborhoods[index][1];
  }
}
